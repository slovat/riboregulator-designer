...
#  pfunc - works in python 3 
#  pairs - works in python 3
#  mfe - works in python 3
#  subopt - works in python 3
#  count - works in python 3
#  energy - works in python 3
#  prob - works in python 3
#  defect - works in python 3
#  sample - works in python 3
#
...
def call_with_pipe(args, cmd_input):
  ...
  output, error = p.communicate(cmd_input.encode('utf-8'))
...
def pfunc(sequences, ordering = None, material = 'dna',
  ...
  if "% Free energy" not in output[-4].decode('utf-8'):
      raise NameError('NUPACK output parsing problem')  #gives an error in python 3
...
def count(sequences, ordering = None, material = 'rna',
  ...
  ## Parse and return output
  if output[-3].decode('utf-8') !=  "% Total number of secondary structures:":
...
def energy(sequences, structure, ordering = None, material = 'rna',
  ...
  ## Parse and return output
  if output[-3].decode('utf-8') != "% Energy (kcal/mol):":
...
def prob(sequences, structure, ordering = None, material = 'rna',
  ...
  ## Parse and return output
  if output[-3].decode('utf-8') != "% Probability:" :  #doesnt work in python 3
    raise ValueError('NUPACK output parsing problem')
...
def defect(sequences, structure, ordering = None, material = 'rna',
  ...
  ## Parse and return output
  if "% Ensemble defect" not in output[-4].decode('utf-8'):
    raise ValueError('NUPACK output parsing problem')
